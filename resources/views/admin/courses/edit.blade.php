                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Course Name" onkeyup="generateSlug()" value="{{ $course->name }}">
                                    <p></p>
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control"
                                        placeholder="Slug" value="{{ $course->slug }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if (!empty($course->CourseBanner))
                                        <div class="mt-3" style="max-height: 300px">
                                            <img src="{{ asset('uploads/course/' . $course->CourseBanner) }}" alt=""
                                                class="img-fluid h-50 w-75">
                                        </div>
                                    @endempty
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @if (!empty($course->CourseLogo))
                                        <div class="mt-3" >
                                            <img src="{{ asset('uploads/course-logo/' . $course->CourseLogo) }}" alt=""
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="ShowInHome" id="ShowInHome" class="form-control">
                                    <option {{ ($course->ShowInHome == 'Yes') ? 'selected' : '' }} value="Yes">Yes</option>
                                    <option {{ ($course->ShowInHome == 'No') ? 'selected' : '' }} value="No">No</option>
                                </select>
